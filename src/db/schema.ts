...
export const complaints = pgTable('complaints', {
  ...
  declarationAccurate: boolean('declaration_accurate').default(false).notNull(),
  declarationEvidence: boolean('declaration_evidence').default(false).notNull(),
  declarationAdditionalInfo: boolean('declaration_additional_info').default(false).notNull(),
  confirmationName: varchar('confirmation_name', { length: 255 }),
